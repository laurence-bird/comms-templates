...
class HandlebarsParsingSpec extends FlatSpec
  ...
  it should "reject templates that references non-existent provided System parameter" in {
    ...
    new HandlebarsParsing(noOpPartialsRetriever).processRequiredDatas(reqData1, emailTemplateFile) should haveInvalid("system.date is not a valid system property field")
  }
  ...
  it should "reject templates that references provided System parameters with the wrong type" in {
    ...
    new HandlebarsParsing(noOpPartialsRetriever).processRequiredDatas(reqData1, emailTemplateFile) should haveInvalid("system.year is not a string")
  }
  ...
  it should "reject templates that references the provided System parameters as the wrong type" in {
    ...
    new HandlebarsParsing(noOpPartialsRetriever).processRequiredDatas(reqData1, emailTemplateFile) should haveInvalid("system property incorrect type")
  }
  ...
  it should "reject templates that references non-existent provided Profile parameter" in {
    ...
    new HandlebarsParsing(noOpPartialsRetriever).processRequiredDatas(reqData1, emailTemplateFile) should haveInvalid("profile.middleName is not a valid profile property field")
  }
  ...
  it should "reject templates that references provided Profile parameters with the wrong type" in {
    ...
    new HandlebarsParsing(noOpPartialsRetriever).processRequiredDatas(reqData1, emailTemplateFile) should haveInvalid("profile.firstName is not a string")
  }
  ...
  it should "reject templates that references the provided Profile parameters as the wrong type" in {
    ...
    new HandlebarsParsing(noOpPartialsRetriever).processRequiredDatas(reqData1, emailTemplateFile) should haveInvalid("profile property incorrect type")
  }
  ...
  it should "reject templates that references non-existent provided Email Recipient parameter" in {
    ...
    new HandlebarsParsing(noOpPartialsRetriever).processRequiredDatas(reqData1, emailTemplateFile) should haveInvalid("recipient.emailSomething is not a valid recipient property field")
  }
  ...
  it should "reject templates that references provided Email Recipient parameters with the wrong type" in {
    ...
    new HandlebarsParsing(noOpPartialsRetriever).processRequiredDatas(reqData1, emailTemplateFile) should haveInvalid("recipient.emailAddress is not a string")
  }
  ...
  it should "reject templates that references the provided Email Recipient parameters as the wrong type" in {
    ...
    new HandlebarsParsing(noOpPartialsRetriever).processRequiredDatas(reqData1, emailTemplateFile) should haveInvalid("recipient property incorrect type")
  }
  ...
  it should "reject templates that references non-existent provided SMS Recipient parameter" in {
    ...
    new HandlebarsParsing(noOpPartialsRetriever).processRequiredDatas(reqData1, smsTemplateFile) should haveInvalid("recipient.mobileNumber is not a valid recipient property field")
  }
  ...
  it should "reject templates that references provided SMS Recipient parameters with the wrong type" in {
    ...
    new HandlebarsParsing(noOpPartialsRetriever).processRequiredDatas(reqData1, smsTemplateFile) should haveInvalid("recipient.telephoneNumber is not a string")
  }
  ...
  it should "reject templates that references the provided SMS Recipient parameters as the wrong type" in {
    ...
    new HandlebarsParsing(noOpPartialsRetriever).processRequiredDatas(reqData1, smsTemplateFile) should haveInvalid("recipient property incorrect type")
  }
  ...
  it should "accept Email templates that correctly reference provided parameters" in {
    ...
    new HandlebarsParsing(noOpPartialsRetriever).processRequiredDatas(reqData1, emailTemplateFile) shouldBe Valid(result)
  }
  ...
  it should "accept SMS templates that correctly reference provided parameters" in {
    ...
    new HandlebarsParsing(noOpPartialsRetriever).processRequiredDatas(reqData1, smsTemplateFile) shouldBe Valid(result)
  }
